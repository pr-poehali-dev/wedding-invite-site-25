const story = [
  ...
  },
  {
    ...
    text: "После той встречи мы уже не могли представить дни друг без друга. Первое свидание подтвердило: это именно тот человек, которого мы искали.",
    align: "right",
  },
  {
    year: "2025",
    emoji: "✈️",
    title: "Путешествия вдвоём",
    text: "Вместе мы открываем мир — каждая поездка становится новой страницей нашей общей истории, полной ярких эмоций и тёплых воспоминаний.",
    align: "left",
  },
  {
    year: "2025",
    emoji: "💍",
    title: "Предложение",
    text: "Андрей встал на одно колено, и ответ был «Да!» — момент, который навсегда останется в наших сердцах.",
    align: "right",
  },
  {
    year: "2026",
